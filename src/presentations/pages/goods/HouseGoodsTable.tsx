...
const HouseGoodsTable = (props: IngredientTableProps) => {
  return (
    <Grid>
      {/* on PC */}
      <Grid
          ...
          <tbody>
            {props.ingredients.map((ingredient, i) => (
              <tr key={i}>
                ...
                >
                  <Tippy
                    content={`Sửa thông tin hàng hóa ${ingredient.name}`}
                    theme="light"
                  >
                    <Button
                  ...
                  <Tippy
                    content={`Xem ảnh  ${ingredient.name}`}
                    theme="light"
                  >
                    <Button
                      className={cx("btn-image")}
                      variant="contained"
                      onClick={() => props.handleGetImgIngredient(ingredient)}
                      disableElevation={true}
                    >
                      <ImageIcon />
                    </Button>
                  ...
                  <Tippy
                    content={`Xóa hàng hóa ${ingredient.name}`}
                    theme="light"
                  >
                    <Button
...
export default HouseGoodsTable;
