...
import FarmDiseasesTable from "./FarmDiseasesTable";
...
import FarmDiseasesModal from "./FarmDiseasesModal";

const cx = classNames.bind(styles);

const FarmDiseasesPage = () => {
...
export default FarmDiseasesPage;
