...
const FarmDiseasesModal = (props: FarmCalendarModalProps) => {
  // fetch lands
      ...
      <Grid>
        <Grid className={cx("area-wrapper")} container columns={12}>
          ...
          >
            <Autocomplete
              ...
              noOptionsText="Không tìm thấy cây trồng"
        ...
        <Grid container spacing={3} className={cx("form-body-wrapper")}>
          ...
          <Fragment>
            ...
            >
              <label className={cx("form-input-label")} htmlFor={"Dientich"}>
                Thời gian xuất hiện <span style={{ color: "red" }}>*</span>
              </label>
            </Grid>
            <Grid
              item
          ...
          <FormInput
            label="Biện pháp"
            required
            placeholder="Biện phải giải quyết"
            type="text"
            value={farmCalendar.seedProvider ?? ""}
            onChange={(event) => {
              let newFarmCalendar: FarmCalendar = {
...
export default FarmDiseasesModal;
