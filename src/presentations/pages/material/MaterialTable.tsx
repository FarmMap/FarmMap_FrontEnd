...
interface MaterialTableProps {
  materials: Material[];
  handleGetImgMaterial: (material: Material) => void;
          ...
          <tbody>
            {props.materials.map((material, i) => (
              <tr key={i}>
                ...
                <td>
                  <p>{material.materialGroup?.name}</p>
                </td>
                <td>
                ...
                >
                  <Tippy
                    content={`Sửa thông tin vật tư ${material.name}`}
                    theme="light"
                  >
                    <Button
                      ...
                      variant="contained"
                      onClick={() => {
                        props.handleEditMaterial(material);
                      }}
                  ...
                  <Tippy
                    content={`Xem ảnh vật tư ${material.name}`}
                    theme="light"
                  >
                    <Button
                      className={cx("btn-image")}
                      variant="contained"
                      onClick={() => props.handleGetImgMaterial(material)}
                      disableElevation={true}
                    >
                      <ImageIcon />
                    </Button>
                  ...
                  <Tippy content={`Xóa vật tư ${material.name}`} theme="light">
                    <Button
                      className={cx("btn-delete")}
                      variant="contained"
                      disableElevation={true}
                      onClick={() => {
                        props.handleDeleteMaterial(material);
                      }}
                    >
                      <Delete />
                    </Button>
