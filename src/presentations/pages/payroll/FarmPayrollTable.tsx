...
import styles from "./FarmPayroll.module.scss";
...
const FarmPayrollTable = (props: FarmCalendarTableProps) => {
  return (
    <Grid>
      {/* on PC */}
      <Grid
          ...
          <tbody>
            {Payroll.map((payroll, i) => (
              <tr key={i}>
                ...
                <td>
                  <p>{payroll.timeLuong}</p>
                </td>
                <td>
                  <p>{payroll.nhancong}</p>
                </td>
                <td>
                  <p>{payroll.status}</p>
                </td>
...
export default FarmPayrollTable;
